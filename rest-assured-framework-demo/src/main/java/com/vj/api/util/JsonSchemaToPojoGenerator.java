...
/**
 * TestNG based class that enables the auto-generation of Java data objects from a given JSON schema<br> 
 * This class leverages the "jsonschema2pojo" library internally
 * @author vj
 */
public class JsonSchemaToPojoGenerator {
	...
	public void generatePojoFromJsonSchema(String jsonSchemaPath, String pojoClassName,
										String pojoPackageName, String pojoDestinationDir) throws IOException {
		JCodeModel codeModel = new JCodeModel();
		URL jsonFileUrl = new File(jsonSchemaPath).toURI().toURL();
	...
	public Object[][] generationParams() {
		return new Object[][] {
			{ "src//main//resources//schemas//AddressSchema.json",
					"Address", "com.vj.api.data", "src//main//java" }
		};
	}
}